...
public record CustomerResponse(UUID id, String email, String fullName, CustomerStatus status, Instant createdDate,
	...
	public static CustomerResponse from(Customer customer) {
		return new CustomerResponse(customer.getId(), customer.getEmail(), customer.getFullName(), customer.getStatus(),
				customer.getCreatedDate(), customer.getLastModifiedDate());
	}
