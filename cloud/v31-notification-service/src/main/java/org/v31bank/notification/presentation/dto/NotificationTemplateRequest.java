 ...
 * @since 0.2.0
 */
public record NotificationTemplateRequest(@NotBlank @Size(max = 32) String code, @NotBlank @Size(max = 100) String name,
		@NotNull NotificationChannel channel, NotificationTemplateStatus status) {
